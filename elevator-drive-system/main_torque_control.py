...
while t < 15:
    ...
    F_load = (PARAM_G/2)*( cabin_total_mass - PARAM_CW_MASS)
    T_load = (PARAM_DRUM_DIAMETER / 2) * F_load
    T_load_referred = T_load * PARAM_GEAR_SPEED_RATIO
...
plt.figure()
plt.plot(time, armature_current)
plt.xlabel('Time (s)')
