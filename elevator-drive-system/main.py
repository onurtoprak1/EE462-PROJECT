...
H_bridge_obj = HBridge_Unipolar(Vin_DC=PARAM_RECTIFIER_V_BUS, carrier_magnitude=1, carrier_frequency=5000, v_ref=0)
...
while t < 2:
    ...
    motor_obj.update_rotor_angular_velocity(dt=PARAM_DT, external_refered_load_torque=110, external_refered_viscous_friction=0, external_refered_inertia=0)
    ...
    current.append(speed_control_PI.get_integral())
    test.append(speed_control_PI.get_error())
